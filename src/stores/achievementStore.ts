    ...
    achievements: [
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.seeds >= 100,
      },
      {
        id: 'first_1000_seeds',
        name: 'Seed Hoarder',
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.seeds >= 1000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.seeds >= 10000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.seeds >= 100000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.seeds >= 1_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.seeds >= 10_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.seeds >= 100_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.seeds >= 1_000_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.seeds >= 10_000_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.seeds >= 100_000_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.seeds >= 1_000_000_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.seeds >= 10_000_000_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.seeds >= 100_000_000_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.seeds >= 1_000_000_000_000_000,
      },
      ...
      // Ant Creation Achievements
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.ants >= 50,
      },
      {
        id: 'first_500_ants',
        name: 'Ant Commander',
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.ants >= 500,
      },
      {
        id: 'first_5000_ants',
        name: 'Ant General',
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.ants >= 5000,
      },
      {
        id: 'first_50000_ants',
        name: 'Ant Warlord',
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.ants >= 50000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.ants >= 500000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.ants >= 5_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.ants >= 50_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.ants >= 500_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.ants >= 5_000_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.ants >= 50_000_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.ants >= 500_000_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.ants >= 5_000_000_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.ants >= 50_000_000_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.ants >= 500_000_000_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.ants >= 5_000_000_000_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.ants >= 50_000_000_000_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.ants >= 500_000_000_000_000_000,
      },
      ...
      // Queen Creation Achievements
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.queens >= 1,
      },
      {
        id: 'create_5_queens',
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.queens >= 5,
      },
      {
        id: 'create_10_queens',
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.queens >= 10,
      },
      {
        id: 'create_25_queens',
        name: 'Royal Overseer',
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.queens >= 25,
      },
      {
        id: 'create_50_queens',
        name: 'Queen Warden',
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.queens >= 50,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.queens >= 100,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.queens >= 250,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.queens >= 500,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.queens >= 1000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.queens >= 5000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.queens >= 10000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.queens >= 50000,
      },
      ...
      // Larvae Production Achievements
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.larvae >= 10,
      },
      {
        id: 'first_100_larvae',
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.larvae >= 100,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.larvae >= 1000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.larvae >= 10000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.larvae >= 100000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.larvae >= 1_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.larvae >= 10_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.larvae >= 100_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.larvae >= 1_000_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.larvae >= 10_000_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.larvae >= 100_000_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.larvae >= 1_000_000_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.larvae >= 10_000_000_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.larvae >= 100_000_000_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.larvae >= 1_000_000_000_000_000,
      },
      {
        ...
        isUnlocked: false,
        unlockCondition: () => useGameStore().resources.larvae >= 10_000_000_000_000_000,
      },
