...
export const seeds: Seed[] = [
  ...
  {
    name: SeedNames.HealingFungus, levelRequired: 5, growthTime: 60 * 60, xpPerAction: 15,
    description: 'A fungus that heals ants, increasing their regeneration for 1 hour.',
    effect: {regenerationRate: 2},
    duration: 60 * 60,
  },
  {
    name: SeedNames.EnergyFungus, levelRequired: 10, growthTime: 90 * 60, xpPerAction: 22,
    description: 'A fungus that provides energy to ants, increasing their crafting speed for 1 hour.',
    effect: {craftingRate: 2},
    duration: 60 * 60,
  },
  {
    name: SeedNames.PheromoneFungus, levelRequired: 15, growthTime: 120 * 60, xpPerAction: 35,
    description: 'A fungus that attracts ants, increasing the spawn rate of ant hills for 2 hours.',
    effect: {spawnRate: 2},
    duration: 120 * 60,
  },
  {
    name: SeedNames.DefenseFungus, levelRequired: 20, growthTime: 180 * 60, xpPerAction: 50,
